...
export default function Home() {
  ...
  // 👇 choose blend per theme
  blend={theme === "light" ? "normal" : "screen"}
  // fade in after the start overlay
...
/>
        ...
        >
          <div className="space-y-6">
            ...
            >
              ...
              <span className="relative inline-flex items-center gap-2 align-middle">
                ...
                <CodeGremlin
                  ...
                  // start the gremlin's fall-in after the text anims; if overlay was skipped,
                  // we still animate immediately with the same delay so timing feels good
                  delay={introDone ? 1.6 : 1.6}
                />
              </span>
            </motion.p>

            <motion.p variants={fromRight as any} className="text-lg md:text-xl leading-8">
              <ReactTyped
                strings={[
                  "Software Engineer",
            ...
            <motion.div variants={fromDown as any} className="flex flex-wrap gap-3">
             <a
  href="#projects"
  className="
...
>
  View Projects
            ...
            <motion.div variants={fromRight as any} className="font-mono text-sm text-[var(--muted)]">
...
<section id="about" className="py-24">
  <div className="mx-auto max-w-6xl px-4">
    ...
    >
      ...
      . I care about experiences that feel fast, accessible, and
      thoughtfully crafted—turning ideas into pixels and pixels into
      happy users.
    </motion.p>
            ...
            {projects.map((p, i) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-sm mt-2 opacity-80 text-[var(--muted)]">
                    {p.desc}
                  </p>
                    ...
                    {p.tech.map((t) => (
                      <span
                        ...
                        className="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium
                                   border border-[color:var(--brand-600)] text-[var(--brand-600)]"
                      >
                        {t}
                      </span>
                    ))}
              ...
              {experience.map((item, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* card */}
                    <div className="rounded-2xl border border-[color:#1f2937] bg-[var(--panel)] p-5">
